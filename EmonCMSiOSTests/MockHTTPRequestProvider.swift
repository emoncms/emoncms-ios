...
final class MockHTTPRequestProvider: HTTPRequestProvider {
  ...
  func request(url: URL) -> AnyPublisher<Data, HTTPRequestProviderError> {
    ...
    case "/feed/aget.json":
      responseString =
        "{\"id\":\"1\",\"userid\":\"1\",\"name\":\"use\",\"datatype\":\"1\",\"tag\":\"Node 5\",\"public\":\"0\",\"size\":\"154624\",\"engine\":\"5\",\"processList\":\"\",\"time\":\"1473946653\",\"value\":\"278\"}"
    case "/feed/get.json":
      responseString = "\"use\""
    case "/feed/data.json":
      if queryValues["mode"] == "daily" {
        ...
        responseString =
          "[[1473793120000,257],[1473793130000,262],[1473793140000,306],[1473793150000,322],[1473793160000,321],[1473793170000,325],[1473793180000,322],[1473793190000,325],[1473793200000,320],[1473793210000,299]]"
      }
    ...
    case "/input/list.json":
      responseString =
        "[{\"id\":\"1\",\"nodeid\":\"1\",\"name\":\"use\",\"description\":\"\",\"processList\":\"\",\"time\":\"1473934060\",\"value\":\"1186\"},{\"id\":\"2\",\"nodeid\":\"1\",\"name\":\"use_kwh\",\"description\":\"\",\"processList\":\"\",\"time\":\"1473934060\",\"value\":\"189.12940747385\"}]"
    case "/dashboard/list.json":
      responseString =
        "[{\"id\":1,\"alias\":\"\",\"name\":\"dash1\",\"description\":\"\"},{\"id\":2,\"alias\":\"\",\"name\":\"dash2\",\"description\":\"\"}]"
    case "/user/auth.json":
  ...
  func request(url: URL, formData: [String: String]) -> AnyPublisher<Data, HTTPRequestProviderError> {
    ...
    else { return Fail(error: .unknown).eraseToAnyPublisher() }
